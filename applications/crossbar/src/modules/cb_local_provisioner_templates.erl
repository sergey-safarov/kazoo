...
-spec content_types_provided(cb_context:context(), http_method(), path_token(), path_token()) -> cb_context:context().
content_types_provided(Context, PT1, PT2) ->
    content_types_provided(Context, cb_context:req_verb(Context), PT1, PT2).

content_types_provided(Context, ?HTTP_GET, DocId, ?IMAGE_REQ) ->
...
-spec content_types_accepted(cb_context:context(), http_method(), path_token(), path_token()) -> cb_context:context().
content_types_accepted(Context, PT1, PT2) ->
    content_types_accepted(Context, cb_context:req_verb(Context), PT1, PT2).

content_types_accepted(Context, ?HTTP_PUT, _, ?IMAGE_REQ) ->
    cb_context:set_content_types_accepted(Context, [{'from_binary', ?MIME_TYPES}]);
content_types_accepted(Context, ?HTTP_POST, _, ?IMAGE_REQ) ->
    cb_context:set_content_types_accepted(Context, [{'from_binary', ?MIME_TYPES}]);
...
validate(Context, PT1) ->
    validate_verb(Context, cb_context:req_verb(Context), PT1).
validate(Context, PT1, PT2) ->
    validate_verb(Context, cb_context:req_verb(Context), PT1, PT2).
...
-spec validate_verb(cb_context:context(), http_method(), path_token(), path_token()) -> cb_context:context().
