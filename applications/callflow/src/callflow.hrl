...
-define(BL_PATTERN_OWNERS_CACHE_KEY(AccountId), {'bl_patterns_owners', AccountId}).
-define(BL_PATTERN_CACHE_KEY(AccountId, OwnerId), {'bl_patterns', AccountId, OwnerId}).
-define(BL_NUMBER_CACHE_KEY(AccountId, OwnerId, Number), {'bl_number', AccountId, OwnerId, Number}).
